...
<html class="x-admin-sm">
    <head>
        ...
        <script type="text/javascript" src="<?=ROOT?>public/Admin/lib/layui/layui.js" charset="utf-8"></script>
                ...
                <form class="layui-form">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" id="L_username" name="username" disabled="" value="15728009797" class="layui-input"></div>
                    </div>
                    <div class="layui-form-item">
