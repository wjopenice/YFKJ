...
<body>
<div class="x-nav">
    <span class="layui-breadcrumb"><a href="">提币订单</a></span>
</div>
    ...
    <div class="layui-row layui-col-space15">
        <div class="layui-col-md12">
            <div class="layui-card">
                ...
                <div class="layui-card-body">
                    <table class="layui-table layui-form" id="thistable" lay-filter="thistable" class="layui-table" lay-data="{skin: 'row', even: true, page:true,limit:10, url:'/Admin/Ajax/withdrawal_order?tel=<?=$_SESSION['tel']?>'}">
                        <thead>
                        <tr>
                            <th lay-data="{field:'uniquekey'}">平台单号</th>
                            <th lay-data="{field:'serialNumber'}">商户单号</th>
