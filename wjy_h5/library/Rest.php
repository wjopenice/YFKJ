...
class Rest extends Controller
{
    ...
    {
        parent::init();
        Dispatcher::getInstance()->disableView(); //立即输出响应，并关闭视图模板
    ...
    protected function success($data = null, $msg = '', $code = 200)
    {
        ...
        $this->response = array(
            ...
            $this->_config['msg'] => $msg ? $this->lang[$msg] : $this->lang['operation completed'],
            $this->_config['data'] => $data,
        );
        $this->code = $code;
        exit();
    ...
    protected function error($msg = '', $data = null, $code = 200)
    {
        $this->response = array(
            ...
            $this->_config['msg'] => $msg ? $this->lang[$msg] : $this->lang['operation failed'],
            $this->_config['data'] => $data,
        );
        $this->code = $code;
        exit();
