...
class RedLogModel extends Model
{
    ...
    public function sendRewardForGroupOwner($uid, $info)
    {
        ...
        $redlog_g['redgroup_id'] = $info['redgroup_id'];
    ...
    public function platformCommission($uid, $info)
    {
        ...
        $redlog_p['redgroup_id'] = $info['redgroup_id'];
        ...
        try {
            ...
            // 增加收益记录
            ProfitModel::addProfit($redlog_p['redpacket_id'], $redlog_p['money'], $redlog_p['currency_id'], 4);
            Db::commit();
